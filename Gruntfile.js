// Generated on 2014-03-25 using generator-lessapp 0.4.9
'use strict';
    ...
    // Compiles LESS to CSS and generates necessary files if requested
        ...
        bowerInstall: {
            app: {
                ...
                exclude: ['<%= config.app %>/bower_components/bootstrap/vendor/assets/javascripts/bootstrap.js']
            },
            less: {
        ...
        // Copies remaining files to places other tasks can use here
        copy: {
            dist: {
                files: [{
                    expand: true,
